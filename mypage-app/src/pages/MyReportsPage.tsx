...
type ReportCategory = "SPAM" | "HARASSMENT" | "INAPPROPRIATE_CONTENT" | "OFF_TOPIC" | "ETC";
type ReportType = "STUDY_ROOM" | "BOARD_POST";
...
export default function MyReportsPage() {
    ...
    const loadReports = async () => {
        ...
        const mockData: CreateReportResponse[] = [
            {
                id: 1,
                reporterNickname: "나",
                reportedUserNickname: "사용자A",
                reportType: "STUDY_ROOM",
                sourceId: 123,
                category: "SPAM",
                description: "스팸 게시물",
                status: "PENDING",
