...
import PtnWordLayout from "./layouts/PtnWordLayout.tsx";
...
import PtnNoteHomePage from "./pages/note/PtnNoteHomePage.tsx";
import { PtnDialogProvider } from "./components/common/PtnDialog.tsx";
...
import PtnWordLandingPage from "./pages/word/PtnWordLandingPage.tsx";
        ...
        <PtnDialogProvider>
          <Routes>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/*" element={<PtnWordLayout />}>
                {/* /learning → 메인 랜딩 페이지 */}
                <Route index element={<PtnWordLandingPage />} />

                {/* /learning/word → 용어 리스트 */}
                <Route path="word" element={<SearchPage />} />

                <Route path="note" element={<PtnNoteHomePage />} />
