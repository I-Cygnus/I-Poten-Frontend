...
import PtnNoteMark from "../../assets/hero/PtnNote-mark.png";
...
export default function PtnNoteHeroBanner({
                                                brandTitle = "포텐노트",
    ...
    const srcs = floatingIcons && floatingIcons.length > 0 ? floatingIcons : [PtnNoteMark];
