...
export const PtnDialogProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
...
export const usePtnDialog = () => {
    const ctx = React.useContext(DialogCtx);
    if (!ctx) throw new Error("usePtnDialog must be used inside <PtnDialogProvider>");
    return ctx;
};
